...
namespace FastColoredTextBoxNS
{
    public class SyntaxHighlighter
    {
        ...
        {
            tb.LeftBrackets = oldBrackets[0];
            tb.RightBrackets = oldBrackets[1];
        }

        protected char[][] RememberBrackets(FastColoredTextBox tb)
        {
            return new []{ tb.LeftBrackets, tb.RightBrackets };
        }
        ...
        public virtual void CSharpSyntaxHighlight(Range range)
        {
            ...
            range.tb.LeftBrackets = "({".ToCharArray();
            range.tb.RightBrackets = "})".ToCharArray();
